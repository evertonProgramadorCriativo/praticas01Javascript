...
'Students must be picked up by a parent, guardian, or a family member over age of 13');


lorraineHansbury.quickFacts();
School.pickSubstituteTeacher(['Jamal Crawford', 'Lou williams',
 'J. R. Smith', 'James harden', 'Manu Ginobli']);
const alSmith = new HighSchool('Al E. Smith', 415, 'Baseball', 
'Basketall', 'Volleyball', 'Track and Field');
